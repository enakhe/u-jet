				...
				>
					...
					<div className="bg-lightBg/30 p-8 rounded-xl shadow-sm">
						<p className="text-lg leading-relaxed text-charcoal/90 mb-6">
							UJET is redefining private jet travel by making it affordable and accessible. We connect travelers with empty leg flights—unused return trips by private jets—offering luxury at up to <span className="font-semibold text-primary">50% off</span> standard rates.
						</p>
					...
					<div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-6">
						...
						>
							<div className="text-primary text-xl font-bold mb-2">50%</div>
						...
						<motion.div
							...
							transition={{ type: "spring", stiffness: 300 }}
						>
							<div className="text-primary text-xl font-bold mb-2">100+</div>
						...
						<motion.div
							...
							transition={{ type: "spring", stiffness: 300 }}
						>
							<div className="text-primary text-xl font-bold mb-2">24/7</div>
						...
						<motion.div
							...
							transition={{ type: "spring", stiffness: 300 }}
						>
							<div className="text-primary text-xl font-bold mb-2">$100/month</div>
